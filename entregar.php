    ...
    <tr> 
      ...
      <th scope="col">&nbsp;</th>
       ...
       <!-- i.Cliente_idCliente in (".$c.") -->
           <?Php 
   $sql1 = "SELECT i.idImpressao, i.Produto_idProduto, i.Etapa_idEtapa, i.Cliente_idCliente, i.Tipo_idTipo, i.qtd, i.Cor, i.tamanho, i.obs , t.modelo, c.nome, c.endereco, p.nome produto, c.telefone FROM impressao i, produto p, etapa e, tipo t, cliente c WHERE i.fl_status = 'Pronto' and i.Produto_idProduto = p.idProduto and i.Etapa_idEtapa = e.idEtapa and i.Tipo_idTipo = t.idTipo and i.Cliente_idCliente = c.idCliente;";
...
?>
    ...
    <tr>
      ...
      <th scope="col">
      <form action="entregar.php" method="post" enctype="multipart/form-data" target="_parent" accept-charset="UTF-8">
