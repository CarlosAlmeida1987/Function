...
<html>
	...
	<form action="modelo.php" method="post" enctype="multipart/form-data" target="_parent" accept-charset="UTF-8">
...
?>
 ...
 <?Php  } ?>       
                ...
                <p><select name="cd_02">
					...
					<option value="<?Php echo $cd_01; ?>"><?Php echo $cd_01; ?></option>
  					<option value="<?Php echo $cd_02; ?>"><?Php echo $cd_02; ?></option>
					<option value="<?Php echo $cd_03; ?>"><?Php echo $cd_03; ?></option>
					<option value="<?Php echo $cd_04; ?>"><?Php echo $cd_04; ?></option>
					<option value="<?Php echo $cd_05; ?>"><?Php echo $cd_05; ?></option>
					<option value="<?Php echo $cd_06; ?>"><?Php echo $cd_06; ?></option>
					<option value="<?Php echo $cd_07; ?>"><?Php echo $cd_07; ?></option>
</select>
...
if($bordado1 != 0) {
if(isset($bordado1)){
 $sql10 = "INSERT INTO `lista_bordados` (`idLista_bordados`, `Impressao_idImpressao`, `Imagens_idImagens`, `nome`, `valor`, `position`, `data`) VALUES (NULL, '".$idImpressao."', '".$bordado1."', '".$ajuste."', '0', '".$cd_01."','".$data."');";
...
if($bordado2 != 0) {
if(isset($bordado2) ){
 $sql11 = "INSERT INTO `lista_bordados` (`idLista_bordados`, `Impressao_idImpressao`, `Imagens_idImagens`, `nome`, `valor`, `position`, `data`) VALUES (NULL, '".$idImpressao."', '".$bordado2."', '".$ajuste."', '0', '".$cd_02."','".$data."');";
...
if($bordado3 != 0) {
if(isset($bordado3)){
$sql12 = "INSERT INTO `lista_bordados` (`idLista_bordados`, `Impressao_idImpressao`, `Imagens_idImagens`, `nome`, `valor`, `position`, `data`) VALUES (NULL, '".$idImpressao."', '".$bordado3."', '".$ajuste."', '0', '".$cd_03."','".$data."');";
...
if($bordado4 != 0) {
if(isset($bordado4)){
$sql13 = "INSERT INTO `lista_bordados` (`idLista_bordados`, `Impressao_idImpressao`, `Imagens_idImagens`, `nome`, `valor`, `position`, `data`) VALUES (NULL, '".$idImpressao."', '".$bordado4."', '".$ajuste."', '0', '".$cd_04."','".$data."');";
...
if($bordado5 != 0) {
if(isset($bordado5)){
$sql14 = "INSERT INTO `lista_bordados` (`idLista_bordados`, `Impressao_idImpressao`, `Imagens_idImagens`, `nome`, `valor`, `position`, `data`) VALUES (NULL, '".$idImpressao."', '".$bordado5."', '".$ajuste."', '0', '".$cd_05."','".$data."');";
...
$sql15 = "INSERT INTO `lista_bordados` (`idLista_bordados`, `Impressao_idImpressao`, `Imagens_idImagens`, `nome`, `valor`, `position`, `data`, `bordar_nome`, `bordar_curso`) VALUES (NULL, '".$idImpressao."', '2', '".$ajuste."', '0', '".$cd_06."','".$data."','".$bordado3_nome."','".$bordado3_curso."');";
...
$sql16 = "INSERT INTO `lista_bordados` (`idLista_bordados`, `Impressao_idImpressao`, `Imagens_idImagens`, `nome`, `valor`, `position`, `data`, `bordar_nome`, `bordar_curso`) VALUES (NULL, '".$idImpressao."', '2', '".$ajuste."', '0', '".$cd_07."','".$data."','".$bordado4_nome."','".$bordado4_curso."');";
